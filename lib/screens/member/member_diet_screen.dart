  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new_rounded, color: t.textSecondary, size: 20),
          onPressed: () => context.canPop() ? context.pop() : context.go('/member'),
        ),
        title: Text(
          'My Diet Plans',
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (ctx, i) => _PlanSummaryCard(
                      ...
                      canDelete: true,
                      delay: i * 60,
                      onDeleted: () => ref.invalidate(memberAllDietPlansProvider),
                    ),
              ...
              child: CustomScrollView(
                ...
                slivers: [
                    ...
                    sliver: SliverToBoxAdapter(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _MacroChip('${plan.targetCalories}',
                                  'kcal', t.warning),
                              const SizedBox(width: 6),
                              _MacroChip('${plan.targetProtein}g',
                                  'protein', t.brand),
                              const SizedBox(width: 6),
                              _MacroChip(
                  ...
                  SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (ctx, i) => _MealCard(
                          meal: meals[i], index: i, delay: i * 60),
