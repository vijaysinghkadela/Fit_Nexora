...
Use template from `C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
