...
```bash
node "C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
