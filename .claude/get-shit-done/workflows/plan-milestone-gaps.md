...
PHASES=$(node "C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/bin/gsd-tools.cjs" phases list)
...
```bash
node "C:/Users/Vinay Pal/Documents/GYMOS_AI/GYMOS_AI/GymOS_AI-main/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(roadmap): add gap closure phases {N}-{M}" --files .planning/ROADMAP.md .planning/REQUIREMENTS.md
```
